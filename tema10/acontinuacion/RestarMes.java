...
public class RestarMes {
    ...
    public RestarMes() {
        ...
        year = Util.askInteger2("Año", Config.MIN_YEAR, Config.MAX_YEAR);
        month = Util.askInteger2("Mes", Config.MIN_MONTH, Config.MAX_MONTH);
        day = Util.askInteger2("Dia", Config.MIN_DAY, Config.MAX_DAY);
        fechaAct = new GregorianCalendar(year, month - 1, day);

        compareYear = Util.askInteger2("Año a restar", Config.MIN_YEAR, Config.MAX_YEAR);
        compareMonth = Util.askInteger2("Mes a restar", Config.MIN_MONTH, Config.MAX_MONTH);
        compareDay = Util.askInteger2("Dia a restar", Config.MIN_DAY, Config.MAX_DAY);
